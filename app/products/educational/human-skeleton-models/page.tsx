...
import { ArrowLeft, Phone, MessageCircle, Mail, Users, Bone } from "lucide-react"
import Link from "next/link"
import Image from "next/image"

export default function HumanSkeletonModelsPage() {
  return (
    <div className="min-h-screen py-16 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-12">
          ...
          <h1 className="text-4xl font-bold mb-4 text-gray-900 dark:text-white">Human Skeleton Models</h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl">
            Anatomically accurate human skeleton models for medical education, biology teaching, and healthcare
            training. Essential tools for understanding human bone structure and anatomy.
          </p>
        </div>
              ...
              <CardContent className="p-6">
                <div className="aspect-square bg-gray-50 dark:bg-gray-700 rounded-lg flex items-center justify-center overflow-hidden">
                  <Image
                    ...
                    alt="Human Skeleton Models - Life-size skeleton on wheeled stand"
                    width={500}
                    height={500}
            ...
            <Card className="dark:bg-gray-800 border-gray-200 dark:border-gray-700 mb-6">
              <CardHeader>
                <CardTitle className="text-2xl text-gray-900 dark:text-white flex items-center">
                  <Bone className="h-6 w-6 mr-2 text-purple-600" />
                  Product Overview
                </CardTitle>
                <CardDescription className="dark:text-gray-400">
                  Detailed anatomical skeleton models for comprehensive learning
                </CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-gray-700 dark:text-gray-300 mb-6">
                  Our human skeleton models are meticulously crafted to provide accurate anatomical representation of
                  the human skeletal system. These models are essential educational tools for medical students,
                  healthcare professionals, and biology educators.
                </p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <ul className="space-y-1 text-gray-700 dark:text-gray-300">
                      <li>• Life-size skeleton (180cm) with stand</li>
                      <li>• Mini skeleton model (85cm) desktop version</li>
                      <li>• Disarticulated skeleton set</li>
                      <li>• Individual bone models</li>
                      <li>• Skull models with removable parts</li>
                      <li>• Spine models with vertebrae details</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-gray-700 dark:text-gray-300">
                      ...
                      <li>• Movable joints and articulations</li>
                      <li>• Detailed bone surface textures</li>
                      <li>• Color-coded bone classifications</li>
                      <li>• Comprehensive instruction manual</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-gray-700 dark:text-gray-300">
                      <li>• 3D visualization of bone structure</li>
                      <li>• Understanding of joint movements</li>
                      <li>• Bone identification and classification</li>
                      <li>• Pathology demonstration capabilities</li>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-gray-700 dark:text-gray-300">
                      ...
                      <li>• Nursing and physiotherapy programs</li>
                      <li>• High school biology classes</li>
                      <li>• Healthcare training centers</li>
                      <li>• Chiropractic and orthopedic clinics</li>
            ...
            <Card className="bg-gradient-to-r from-purple-800 to-purple-900 text-white border-0">
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  <a
                    href="https://wa.me/251949764843?text=I'm interested in Human Skeleton Models for educational purposes. Please provide pricing and model options."
                    target="_blank"
