...
export default function PotassiumAluminumSulphatePage() {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Potassium Aluminum Sulphate</h1>
              <p className="text-xl text-gray-600 dark:text-gray-300">
                High-quality potassium aluminum sulphate (KAl(SO₄)₂·12H₂O) crystals for water treatment and industrial
                applications.
              </p>
            </div>
